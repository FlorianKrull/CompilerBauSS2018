...
typedef void (*mCc_ast_visit_statement_list_cb)(struct mCc_ast_statement_list *, void *);

typedef void (*mCc_ast_visit_compound_cb)(struct mCc_ast_statement *, void *);
...
struct mCc_ast_visitor {
	...
	mCc_ast_visit_literal_cb literal_alpha_num;
	mCc_ast_visit_literal_cb literal_digit;
	mCc_ast_visit_literal_cb literal_identifier;
